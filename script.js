const urlBase = 'https://jsonplaceholder.typicode.com/posts' // Esta es la url con la que inteactuaremos
let posts = [] // inicimaos los posteos como un array vacio
...
function renderPostList(){
    ...
    posts.forEach(post => {
        ...
        <div id="editForm-${post.id}" class="editForm" style="display: none"> 
             <label form="editTitle">Titulo: </label>
             <input id="editTitle-${post.id}" type="text" value="${post.title}" required>
             <label form="editBody">Comentario: </label>
